...
* 需运行Windows Server 2016或更高版本
* 已安装Chloros（仅需安装一次）
* 任何设备上激活的许可证 （缓存许可证已复制至服务器）
...
**答：**可以！请结合Windows任务计划程序与Python脚本使用：
